$(document).ready(function() {
	...
	$("#loginButton").click(function() {
		...
		$.post("/Ankur_Portfolio/rest/v1/users/auth", JSON.stringify({
			"email" : $("#email").val(),
	...
	$("#createButton").click(function() {
		$.post("/Ankur_Portfolio/rest/v1/expenses", JSON.stringify({
			"dt":$("#dateTime").val(),
			  "amount":$("#amount").val(),
			  "email": email,
	...
	$("#deleteButton").click(function() {
		...
		$.ajax({
	        type: "DELETE",
	        url: "/Ankur_Portfolio/rest/v1/expenses/"+radio,
	        contentType: "application/x-www-form-urlencoded; charset=utf-8",
	        success: function (result) {
	        	alert("Row deleted successfully");
	    		$.ajax({
	    	        type: "GET",
	    	        url: "/Ankur_Portfolio/rest/v1/expenses?email="+email+"&admin="+isAdmin,
	...
	$("#updateButton").click(function() {
		...
		radio = radio.substring(radio.indexOf("_")+1);
			...
			if ($("#updateButton").html() === 'Edit') {
				...
				$.post("/Ankur_Portfolio/rest/v1/expenses/update", JSON.stringify({
	...
	$("#viewCustomButton").click(function() {
		...
		$.ajax({
	        type: "POST",
	        url: "/Ankur_Portfolio/rest/v1/expenses/range",
	        data: JSON.stringify({
