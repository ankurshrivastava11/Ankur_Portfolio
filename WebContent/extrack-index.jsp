...
<body id="page-top" data-spy="scroll" data-target=".navbar-fixed-top">
	...
	<div id="footer">
		<div class="container text-center">
			<div class="container-fluid text-center copyrights">
				<div class="col-md-8 col-md-offset-2">
					<div class="social">
						<ul>				
							<li><a href="http://www.facebook.com/ankur.shrivastava11"><i class="fa fa-facebook"></i></a></li>
							<li><a href="http://www.linkedin.com/in/ankurshrivastava11/"><i class="fa fa-linkedin"></i></a></li>
							<li><a href="https://www.github.com/ankurshrivastava11/"><i class="fa fa-github"></i></a></li>
							<li><a href="mailto:shrivastava.ankur1190@gmail.com"><i class="fa fa-envelope" aria-hidden="true"></i></a></li>
						</ul>
					</div>
		...
		<script type="text/javascript" src="js/ex-track-js/jquery.1.11.1.js"></script>
		<script type="text/javascript" src="js/ex-track-js/bootstrap.js"></script>
		<script type="text/javascript" src="js/ex-track-js/SmoothScroll.js"></script>
		<script type="text/javascript" src="js/ex-track-js/nivo-lightbox.js"></script>
		<script type="text/javascript" src="js/ex-track-js/jquery.isotope.js"></script>
		<script type="text/javascript" src="js/ex-track-js/jqBootstrapValidation.js"></script>
		<script type="text/javascript" src="js/ex-track-js/contact_me.js"></script>
		<script type="text/javascript" src="js/ex-track-js/main.js"></script>
		<script type="text/javascript" src="js/ex-track-js/ex-track.js"></script>
